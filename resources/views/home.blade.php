            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200"
                    ...
                    <div class="overflow-x-auto flex flex-row ">
                        <div class="min-w-screen min-h-screen bg-gray-100 flex space-evenly justify-center bg-gray-100 font-sans overflow-hidden">
                            <div class="w-4/5 lg:w-5/6">
                                <div class="bg-white shadow-md rounded my-6 ">
                                    <table class="min-w-max w-fit table-auto">
                                        ...
                                        @foreach($cryptoAssets as $key=>$cryptoAsset)
                                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                                ...
                                                <td class="py-3 px-6 text-left whitespace-nowrap">
                                                    <div class="flex items-center">
                                                        ...
                                                        <a href="/assets/{{ $cryptoAsset->id }}"><span
                                                                class="font-medium">{{ $cryptoAsset->name }}</span></a>
                                                    </div>
                                                </td>
                                                    ...
                                                    <form method="POST">
                                                        ...
                                                        <div class="flex item-center justify-center">
                                                            <div
                                                                ...
                                                                <button type="submit"
                                                                        formaction="/wallet/buy/{{ $cryptoAsset->id }}">
